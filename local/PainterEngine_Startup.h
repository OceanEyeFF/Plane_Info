...
#define PX_APPLICATION_MEMORYPOOL_UI_SIZE 1024*1024*128
#define PX_APPLICATION_MEMORYPOOL_RESOURCES_SIZE 1024*1024*1500
#define PX_APPLICATION_MEMORYPOOL_GAME_SIZE 1024*1024*32
