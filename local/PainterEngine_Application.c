...
px_void PX_ApplicationPostEvent(PX_Application *pApp,PX_Object_Event e)
{
	...
	if(e.Event==PX_OBJECT_EVENT_WINDOWRESIZE)
	{
		...
		PX_UIUpdateObjectsPostions(&pApp->ui,pApp->ensure_page_root,&pApp->ensure_page_json.rootValue,pRuntime->surface_width,pRuntime->surface_height);
		PX_UIUpdateObjectsPostions(&pApp->ui,pApp->check_fail_page_root,&pApp->check_fail_page_json.rootValue,pRuntime->surface_width,pRuntime->surface_height);
		PX_UIUpdateObjectsPostions(&pApp->ui,pApp->book_successful_root,&pApp->book_successful_json.rootValue,pRuntime->surface_width,pRuntime->surface_height);
	}
